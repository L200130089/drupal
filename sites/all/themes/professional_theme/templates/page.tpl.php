...
<div id="wrapper">
  <header id="header" role="banner">
    ...
    <?php if ($site_name): ?><h1 id="site-title"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><?php print "Universitas Muhammadiyah Surakarta"; ?></a></h1><?php endif; ?>
	  ...
	  <li>
        <article class="post">
          ...
          <a href="<?php print url($slide4_url); ?>">
            ...
            <?php else: ?>
              <img src="<?php print base_path() . drupal_get_path('theme', 'professional_theme') . '/images/slide-image-4.jpg'; ?>" class="slide-image" alt="<?php print $slide4_alt; ?>" /></a>
            <?php endif; ?>
          <div class="clear"></div>
        </article>
      </li>
	  ...
	  <li>
        <article class="post">
          ...
          <a href="<?php print url($slide5_url); ?>">
            ...
            <?php else: ?>
              <img src="<?php print base_path() . drupal_get_path('theme', 'professional_theme') . '/images/slide-image-5.jpg'; ?>" class="slide-image" alt="<?php print $slide5_alt; ?>" /></a>
            <?php endif; ?>
          <div class="clear"></div>
        </article>
      </li>
